document.addEventListener('DOMContentLoaded', function() {
    ...
    if (indexYesBtn) {
        indexYesBtn.addEventListener('click', function() {
            ...
            document.querySelector('.breakersita-section').style.display = 'none';

            // Show final message
            const finalMessage = document.createElement('p');
            finalMessage.classList.add('special-message');
            finalMessage.textContent = '¡Estoy muy feliz! Espero poder hacerte muy feliz y compartir momentos inolvidables juntos 😊';
    ...
    if (indexNoBtn) {
        indexNoBtn.addEventListener('click', function() {
            ...
            const finalMessage = document.createElement('p');
            finalMessage.classList.add('special-message');
            finalMessage.textContent = 'Entiendo tu decisión y la respeto. Espero que podamos seguir compartiendo momentos especiales como amigos. ¡Eres muy importante para mí!';
            finalMessage.style.animation = 'fadeIn 2s ease-in-out';
            document.querySelector('.message').appendChild(finalMessage);
    ...
    if (surpriseYesBtn) {
        surpriseYesBtn.addEventListener('click', function() {
            ...
            const finalMessage = document.createElement('p');
            finalMessage.classList.add('special-message');
            finalMessage.textContent = "Sabía que dirías que sí 😌️, porque eres una persona increíble. Quiero compartir contigo los mejores momentos de mi vida, apoyarte en todo lo que necesites y construir una relación llena de amor y respeto. ¡Eres muy especial para mí!";
            finalMessage.style.animation = 'fadeIn 2s ease-in-out';
